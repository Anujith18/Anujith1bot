...
# Bot information
SESSION = environ.get('SESSION', 'Anujith1bot')
...
PICS = (environ.get('PICS', 'https://envs.sh/iwn.jpg')).split()
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002110922261') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', ' -1002015288592')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://GG:GG@ggg.in1al.mongodb.net/?retryWrites=true&w=majority&appName=GGG")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "GG")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'NIKHIL')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/AllMalayalamSupportGroup')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Update_Channel3')
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '89b698ba1fb405905af84b29c0257e78fe3d90c3')
